/* Tested on my HU-650
    7b: changed handling of lost connection
...
const byte listLen = 18;
byte cmdLen[listLen] = {3, 5, 5, 5, 4, 4, 3, 3, 3, 3, 3, 3, 3, 3, 5, 3, 4, 3};
...
void loop() {
  ...
  */
  ...
  while (!BUSY) {
    ...
    if (BUSY) msgCount++; //BUSY switched to idle, therefore increase counter
  }
